...
* `Arcangelo Corelli – Trio Sonatas <https://github.com/DCMLab/corelli/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the first movement of the first trio sonata has the following files:
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/corelli/issues>`__ and feel free to fork and submit pull requests.
